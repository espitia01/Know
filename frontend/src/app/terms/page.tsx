    ...
    <div className="min-h-screen bg-background text-foreground">
      <nav className="sticky top-0 z-50 bg-background/80 backdrop-blur-xl border-b border-border/80">
        <div className="max-w-6xl mx-auto px-6 h-[60px] flex items-center justify-between">
          ...
          <Link
            href={homeHref}
            className="text-[13px] font-medium text-muted-foreground/80 hover:text-foreground/90 transition-colors"
          >
            &larr; Back
          </Link>
        </div>
      ...
      <main className="max-w-2xl mx-auto px-6 py-20">
        <h1 className="text-[32px] font-extrabold tracking-[-0.04em] text-foreground mb-2">
          Terms of Service
        </h1>
        <p className="text-[13px] text-muted-foreground/80 mb-12">
          Last updated: April 17, 2026
        </p>

        <div className="space-y-10 text-[14px] leading-[1.75] text-muted-foreground">
          <section>
            <h2 className="text-[15px] font-semibold text-foreground mb-2">1. Acceptance of Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-[15px] font-semibold text-foreground mb-2">2. Description of Service</h2>
            <p>
          ...
          <section>
            <h2 className="text-[15px] font-semibold text-foreground mb-2">3. Accounts &amp; Authentication</h2>
            <p>
          ...
          <section>
            <h2 className="text-[15px] font-semibold text-foreground mb-2">4. Subscriptions &amp; Billing</h2>
            <p>
            ...
            <p className="mt-3">
              <strong className="text-foreground">Upgrades.</strong> You may upgrade your plan at any time (e.g., from Scholar
          ...
          <section className="bg-amber-50/60 border border-amber-200/60 rounded-2xl p-6">
            <h2 className="text-[15px] font-semibold text-foreground mb-2">5. No Refunds Policy</h2>
          ...
          <section>
            <h2 className="text-[15px] font-semibold text-foreground mb-2">6. Acceptable Use</h2>
            <p>
          ...
          <section>
            <h2 className="text-[15px] font-semibold text-foreground mb-2">7. Intellectual Property</h2>
            <p>
          ...
          <section>
            <h2 className="text-[15px] font-semibold text-foreground mb-2">8. AI-Generated Content Disclaimer</h2>
            <p>
          ...
          <section>
            <h2 className="text-[15px] font-semibold text-foreground mb-2">9. Privacy &amp; Data</h2>
            <p>
          ...
          <section>
            <h2 className="text-[15px] font-semibold text-foreground mb-2">10. Service Availability</h2>
            <p>
          ...
          <section>
            <h2 className="text-[15px] font-semibold text-foreground mb-2">11. Limitation of Liability</h2>
            <p>
          ...
          <section>
            <h2 className="text-[15px] font-semibold text-foreground mb-2">12. Termination</h2>
            <p>
          ...
          <section>
            <h2 className="text-[15px] font-semibold text-foreground mb-2">13. Contact</h2>
            <p>
              For questions about these terms, please use the feedback button in the application
              or reach out through our{" "}
              <a href="https://discord.gg/BgNdPsVfDE" target="_blank" rel="noopener noreferrer" className="underline hover:text-muted-foreground transition-colors">Discord community</a>.
            </p>
          </section>
        </div>
