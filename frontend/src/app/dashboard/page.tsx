        ...
        <div className="max-w-[400px] w-full space-y-10 text-center">
          ...
          <div className="flex items-center justify-center gap-8 pt-2">
            <button
              ...
              className="text-[12px] text-gray-400 hover:text-gray-700 transition-colors font-medium"
            >
              Settings
            </button>
            <button
      ...
      <div className="max-w-[480px] w-full space-y-10">
            ...
            {loading ? (
              ...
              <div className="text-center space-y-3">
                ...
                <div>
                  ...
                  <p className="text-[13px] text-gray-400 mt-0.5">arXiv, Nature, Science, PRL...</p>
                </div>
              </div>
            )}
          </div>
        ...
        <div className="flex items-center justify-center gap-8 pt-4">
          ...
          <a
            ...
            className="text-[12px] text-gray-400 hover:text-gray-700 transition-colors font-medium flex items-center gap-1.5"
          >
