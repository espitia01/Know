    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-background text-foreground bg-mesh px-4 py-16 relative">
      ...
      <div className="mb-8 flex flex-col items-center gap-4">
        ...
        <div className="text-center">
          <h1 className="font-display text-[24px] font-bold tracking-[-0.03em] text-foreground">Welcome back</h1>
          <p className="text-[13px] text-muted-foreground mt-1">Sign in to continue learning</p>
        </div>
      </div>
