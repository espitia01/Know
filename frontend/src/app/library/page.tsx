      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className="w-56 shrink-0 border-r border-border glass-subtle overflow-y-auto p-4 space-y-4">
          ...
          <div className="flex gap-1 glass-subtle rounded-xl p-0.5">
            ...
            <button
              ...
              className={`flex-1 inline-flex items-center justify-center gap-1 text-[11px] font-semibold py-1.5 rounded-lg transition-colors ${
                sidebarTab === "workspaces"
                  ? "bg-card text-foreground border border-border"
                  : workspacesUiEnabled
                  ? "text-muted-foreground hover:text-foreground/90"
            ...
            <div className="space-y-2">
              {workspaceFeaturesComingSoon ? (
                ...
                <div className="rounded-xl border border-border/70 bg-background/60 p-4 space-y-3">
                  ...
                  <Link
                    href="/#pricing"
                    className="block text-center text-[11px] font-semibold bg-foreground text-background py-1.5 rounded-lg transition-opacity hover:opacity-90"
                  >
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          {selectedPapers.size > 0 && (
                    <div className="flex items-center gap-3 mb-4 px-4 py-2.5 rounded-xl border border-border bg-card animate-fade-in">
