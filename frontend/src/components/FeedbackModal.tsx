      ...
      <div className="relative glass-strong rounded-2xl shadow-2xl max-w-md w-full mx-4 overflow-hidden animate-fade-in">
        ...
        {!sent ? (
            ...
            {isAuthed ? (
              <>
                ...
                <div className="px-6 pb-6 flex gap-3">
                  <button
                    onClick={onClose}
                    className="flex-1 text-[13px] font-medium py-3 rounded-xl glass text-gray-700 hover:bg-white/80 transition-colors"
                  >
                    Cancel
                  </button>
                  <button
                    ...
                    className="flex-1 text-[13px] font-semibold py-3 rounded-xl btn-primary-glass text-white transition-all disabled:opacity-40 disabled:cursor-not-allowed"
                  >
              ...
              <div className="px-6 pb-6 flex gap-3">
                ...
                <Link
                  href="/sign-in"
                  className="flex-1 text-[13px] font-semibold py-3 rounded-xl btn-primary-glass text-white transition-all text-center"
                >
                  Sign In
                </Link>
              </div>
          ...
          <div className="px-6 py-12 text-center">
            ...
            <button
              onClick={onClose}
              className="mt-8 text-[13px] font-semibold px-6 py-3 rounded-xl btn-primary-glass text-white transition-all"
            >
              Done
            </button>
          </div>
