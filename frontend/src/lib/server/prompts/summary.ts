...
export function buildSummaryDeepPrompt(args: {
  ...
  const system = [
    `You are an expert science editor producing the detailed body of a structured paper summary. The overview, tl_dr, key contributions, and key equations have already been generated by an earlier pass — DO NOT repeat them. Fill ONLY the heavy fields below.`,
    SHARED_RULES,
